...
| 类别 | 数量 | 说明 |
|---|---|---|
| **可加载风格**（含 JSON brief） | 136 份 | 12 顶层内置 + 124 子目录参考（124 = 35+46+40+3，不含 `04_来源_guizang/` 的 7 份组件模板）；`leo-ppt style list` 枚举 136 个 |
| **分节轴规范**（markdown 分节） | 119 份 | 论证模式 5 · 信息图类型 11 · 图片渲染 20 · 结构布局 7 · 品牌身份 20 · 图表语法 12 · 版式库 24 · 页面语义 20 |
...
- 视觉风格配对：`00_索引/视觉风格配对.md`（视觉风格 ↔ 图片渲染逐条配对，84 组）
