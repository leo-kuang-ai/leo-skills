...
`.opencode/skills/spec-app-consistency-audit/scripts/` and `tests/unit/spec-app-consistency-audit-*`.
...
3. Run `extract-figma-contract.js` with:
   ...
   ```bash
   node .opencode/skills/spec-app-consistency-audit/scripts/extract-figma-contract.js \
     --source . \
