...
Command support root: `.qoder/skills/spec-app-consistency-audit`. Treat it as the loaded skill directory whenever this inlined workflow refers to `SKILL_DIR` or the directory containing `SKILL.md`.
...
```text
.qoder/skills/spec-app-consistency-audit/prompts/
```
...
Full command detail lives in [Mode, Output, And Issue Contract](.qoder/skills/spec-app-consistency-audit/references/mode-output-contract.md).
...
Detailed field rules are in [Mode, Output, And Issue Contract](.qoder/skills/spec-app-consistency-audit/references/mode-output-contract.md).
...
```text
.qoder/skills/spec-app-consistency-audit/scripts/
```
...
```text
.qoder/skills/spec-app-consistency-audit/rule-packs/
```
...
- [Headless Runner And Artifact Lifecycle](.qoder/skills/spec-app-consistency-audit/references/headless-runner.md): full runner pipeline, fail-fast reason codes, and artifact-lifecycle/enum rules deferred from this entry.
- [Mode, Output, And Issue Contract](.qoder/skills/spec-app-consistency-audit/references/mode-output-contract.md): detailed mode tokens, scope resolution, Figma materialization, output/writeback, and issue protocol fields.
- [`.qoder/skills/spec-app-consistency-audit/references/report-format.md`](.qoder/skills/spec-app-consistency-audit/references/report-format.md): the report section structure that downstream Report-Writer steps emit.
- [`.qoder/skills/spec-app-consistency-audit/references/pilot-validation.md`](.qoder/skills/spec-app-consistency-audit/references/pilot-validation.md): minimal pilot-record format gating the v0.2 readiness decision.
- [`.qoder/skills/spec-app-consistency-audit/references/ecc-source-lock.json`](.qoder/skills/spec-app-consistency-audit/references/ecc-source-lock.json): ECC source-lock policy consumed by `.qoder/skills/spec-app-consistency-audit/scripts/merge-contracts.js` and the orchestrator prompt to keep ECC-derived lenses read-only.
