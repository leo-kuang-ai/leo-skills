...
```json
{
  ...
  "aliases": ["仪表盘风", "数据大屏风", "BI风", "dashboard"],
  ...
  "color_palette": {
    ...
    "accent": "alert amber #F59E0B for threshold highlights; success green #10B981 only for positive deltas",
    "neutral": "slate #475569, grid line #E2E8F0, panel bg #F8FAFC"
  },
  "typography": {
    "title": "bold clean sans (Inter / 思源黑体 Bold), dashboard header style",
    ...
    "body": "compact data sans (Inter / 思源黑体), tabular numerals, left-aligned"
  },
  "layout_patterns": [
  ...
  "negative_prompt": [
    "dark control-room or monitoring wall backgrounds",
    "dense cyberpunk glow and heavy neon",
    "unreadable tiny table text",
    "random numbers without structure",
    "oppressive black panels"
  ],
  "paired_illustration": {
    "family": "dashboard",
    "density": "core"
