...
- `REDFOX_API_KEY` is issued by [Redfox Hub](https://redfox.hk/dashboard/keys) (`https://redfox.hk`) for API authentication.
...
- Get REDFOX_API_KEY (apply at [Redfox Hub](https://redfox.hk/dashboard/keys))
