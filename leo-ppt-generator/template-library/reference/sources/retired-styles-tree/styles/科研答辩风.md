...
```json
{
  ...
  "taxonomy": {
    "families": [
      "family:academic-defense"
    ]
  },
  "aliases": ["学术答辩风", "课题申报风", "基金答辩风", "thesis-defense"],
  ...
  "canvas": {
    ...
    "density": "two declared tiers, choose one at the visual-direction confirmation: [minimal 组会简报档] low-to-medium density, one assertion + one visual + generous whitespace per page, roughly six or fewer text lines, for group meetings and conference-style reading reports; [dense-defense 答辩证据密集档] committee-grade evidence-dense pages for thesis defense, proposal and mid-term review: persistent page chrome (left sidebar TOC rail listing all five modules with the current one highlighted, plus slim footer with module/source/page number), body organized into 2-4 numbered tinted panels per page, 4-column substance blocks (icon + bold headline + 2-3 lines of concrete facts + one bold mini-stat), real numbers and redrawn tables and embedded original figures instead of keyword cards ('Numbers, not adjectives'), density disciplined by grid and tints while keeping clear reading order and alignment"
  },
  "color_palette": {
  ...
  "typography": {
    ...
    "labels": "small sans labels (思源黑体 / Noto Sans SC) for figure captions, axis and source notes"
  },
  "page_system": {
  ...
  "layout_patterns": [
    ...
    "dense-defense tier: left sidebar TOC rail with 2-4 numbered evidence panels per body",
    "dense-defense tier: 4-column substance block with concrete numbers, redrawn tables, and embedded original figures"
  ],
  ...
  "layout_blueprints": [
    ...
    {
      "name": "dense-defense · 答辩证据密集档（左 TOC 侧栏 + 编号面板）",
      "sections": [
        {
          "position": "left sidebar (full-height TOC rail)",
          "count": 1,
          "labels": [
            "module list of all five beats (背景/问题/方法/证据/结论) with current module highlighted by filled deep-blue pill and red left tab; small project mark at rail top; inactive modules muted grey"
          ]
        },
        {
          "position": "body top",
          "count": 1,
          "labels": [
            "numbered assertion title (e.g. 3.2 复杂度分析：…) with thin rule ending in a dot"
          ]
        },
        {
          "position": "body grid",
          "count": 4,
          "labels": [
            "numbered panel ① mechanism diagram or embedded original figure",
            "numbered panel ② redrawn results table with winning cell highlighted",
            "numbered panel ③ substance block: real numbers, not adjectives (h=8 / d=512 / O(n²·d) / 28.4 BLEU style)",
            "numbered panel ④ KPI mini-stat or highlighted takeaway box with left accent bar"
          ]
        },
        {
          "position": "footer line",
          "count": 1,
          "labels": [
            "module · source · page number"
          ]
        }
      ]
    }
  ...
  "negative_prompt": [
    "minimalist empty pages or excessive whitespace",
    "marketing hero layouts",
    "cartoon illustrations or playful stickers",
    "decorative gradients and random icons",
    "vague stock photos, fruits, animals, or people cutouts"
  ],
  "paired_illustration": {
    "family": "diagram",
    "density": "supportive"
