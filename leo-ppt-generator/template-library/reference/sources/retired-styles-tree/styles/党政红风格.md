...
```json
{
  ...
  "taxonomy": {
    "families": [
      "family:government-red"
    ]
  },
  "aliases": ["党建红", "政府红", "红色党政", "party-red"],
  ...
  "typography": {
    "title": "formal Chinese government-document voice: Xiaobiaosong (方正小标宋) style title face, or Source Han Serif/Songti when Xiaobiaosong is unavailable; dignified, authoritative, suited to official documents",
    "body": "Fangsong (仿宋) style body face for official-document register, or Source Han Sans when Fangsong is unavailable; concise, highly readable, aligned to a strict grid",
  ...
  "negative_prompt": [
    "invented or inaccurate official marks",
    "glitter, glossy 3D text, or thick shadows",
    "excessive ceremonial decoration or festival and wedding motifs",
    "cartoon styling and unrelated stock imagery",
    "repeating the same landmark ornament without content justification"
  ],
  "paired_illustration": {
    "family": "photographic",
    "density": "supportive"
