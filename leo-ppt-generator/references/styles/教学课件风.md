...
```json
{
  ...
  "taxonomy": {
    "families": [
      "family:children-cartoon",
      "family:teaching"
    ]
  },
  "aliases": ["课件风", "教学风", "PPT课件", "courseware"],
  ...
  "color_palette": {
    ...
    "accent": "restrained auxiliary amber #D97706 for emphasis highlights and key-term marks, chosen by semantic category and used sparingly",
  ...
  "negative_prompt": [
    "text-only pages or repetitive card grids",
    "purely decorative illustration",
    "generic AI-looking imagery",
    "random 3D icons and playful stickers",
    "unsupported futuristic styling or excessive gradients"
  ],
  "paired_illustration": {
    "family": "photographic",
    "density": "supportive"
