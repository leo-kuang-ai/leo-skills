...
> 来源注记：dense-defense 答辩档（左 TOC 侧栏、编号面板、Numbers-not-adjectives 实质
> 纪律、重绘表格）改编自 academic-ppt-master `references/modes/academic.md` 与
> `references/visual-styles/academic-defense.md`（MIT，Copyright (c) 2026 M1n-n9 and
> contributors），据用户线下授权。
