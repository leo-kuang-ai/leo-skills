...
```json
{
  ...
  "style_name": "清爽专业风",
  "aliases": ["简约专业风", "清新商务风", "clean-corporate"],
  ...
  "typography": {
    "title": "clear bold sans-serif (思源黑体 Source Han Sans / Noto Sans SC), report-like and authoritative",
    "body": "clean sans-serif (思源黑体 / Inter), strong hierarchy, left-aligned for readability",
  ...
  "negative_prompt": [
    "overly decorative poster layout",
    "random stock photos or cute stickers",
    "dense unreadable tables",
    "exaggerated marketing style",
    "playful neon, luxury gold, or heavy dark backgrounds"
  ],
  "paired_illustration": {
    "family": "flat",
    "density": "supportive"
