...
Command support root: `.opencode/skills/spec-write-tasks`. Treat it as the loaded skill directory whenever this inlined workflow refers to `SKILL_DIR` or the directory containing `SKILL.md`.
...
8. Do not hand-edit `.claude/`, `.codex/`, or `.opencode/skills/` as source fixes.
...
Use [Task Quality Guide](.opencode/skills/spec-write-tasks/references/task-quality-guide.md) for accepted/rejected input classes, task-ready source plan rules, source orientation, traceability, vertical slices, `context_refs`, `done_signal`, `stop_if`, and review-intent quality guidance.
...
Use [Execution Handoff Contract](.opencode/skills/spec-write-tasks/references/execution-handoff-contract.md) for branch outputs, final envelope fields, high-risk review handoff, hash rules, and failure reason codes.

## Task Pack Output

When compiling, read [Task Pack Schema](.opencode/skills/spec-write-tasks/references/task-pack-schema.md) and write the task pack body with:
...
Every run must end with the compact envelope from [Execution Handoff Contract](.opencode/skills/spec-write-tasks/references/execution-handoff-contract.md).
...
- [Execution Handoff Contract](.opencode/skills/spec-write-tasks/references/execution-handoff-contract.md)
- [Task Pack Schema](.opencode/skills/spec-write-tasks/references/task-pack-schema.md)
- [Task Quality Guide](.opencode/skills/spec-write-tasks/references/task-quality-guide.md)
