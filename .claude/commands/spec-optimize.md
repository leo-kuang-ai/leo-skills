...
Resolve `.claude/spec-first/workflows/spec-optimize/scripts/measure.sh`, `.claude/spec-first/workflows/spec-optimize/scripts/parallel-probe.sh`, and `.claude/spec-first/workflows/spec-optimize/scripts/experiment-worktree.sh` relative to this skill's loaded directory. The measurement working directory remains the project directory named by the optimization spec.
...
2. Include all required top-level sections from `.claude/spec-first/workflows/spec-optimize/references/experiment-log-schema.yaml`: `spec`, `run_id`, `started_at`, `baseline`, `experiments`, and `best`
...
3. Fill the experiment prompt template (`.claude/spec-first/workflows/spec-optimize/references/experiment-prompt-template.md`) with:
...
5. **If gates pass AND primary type is `judge`**:
   ...
   - Fill the judge prompt template (`.claude/spec-first/workflows/spec-optimize/references/judge-prompt-template.md`) for each batch
