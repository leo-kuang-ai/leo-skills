...
Command support root: `.claude/spec-first/workflows/spec-polish`. Treat it as the loaded skill directory whenever this inlined workflow refers to `SKILL_DIR` or the directory containing `SKILL.md`.
...
| Type | Recipe |
|------|--------|
| `rails` | `.claude/spec-first/workflows/spec-polish/references/dev-server-rails.md` |
| `next` | `.claude/spec-first/workflows/spec-polish/references/dev-server-next.md` |
| `vite` | `.claude/spec-first/workflows/spec-polish/references/dev-server-vite.md` |
| `nuxt` | `.claude/spec-first/workflows/spec-polish/references/dev-server-nuxt.md` |
| `astro` | `.claude/spec-first/workflows/spec-polish/references/dev-server-astro.md` |
| `remix` | `.claude/spec-first/workflows/spec-polish/references/dev-server-remix.md` |
| `sveltekit` | `.claude/spec-first/workflows/spec-polish/references/dev-server-sveltekit.md` |
| `procfile` | `.claude/spec-first/workflows/spec-polish/references/dev-server-procfile.md` |
...
Load `.claude/spec-first/workflows/spec-polish/references/ide-detection.md` for the env-var probe table. Open the browser using the IDE's mechanism (Claude Code → `open`, Cursor → Cursor browser, VS Code → Simple Browser).
...
- `.claude/spec-first/workflows/spec-polish/references/launch-json-schema.md` — launch.json schema + per-framework stubs
- `.claude/spec-first/workflows/spec-polish/references/ide-detection.md` — host IDE detection and browser-handoff
- `.claude/spec-first/workflows/spec-polish/references/dev-server-detection.md` — port resolution documentation
- `.claude/spec-first/workflows/spec-polish/references/dev-server-rails.md` — Rails dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-next.md` — Next.js dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-vite.md` — Vite dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-nuxt.md` — Nuxt dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-astro.md` — Astro dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-remix.md` — Remix dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-sveltekit.md` — SvelteKit dev-server defaults
- `.claude/spec-first/workflows/spec-polish/references/dev-server-procfile.md` — Procfile-based dev-server defaults

Scripts (invoked via `bash "$SKILL_DIR/scripts/<name>"` — see Phase 1 for `SKILL_DIR`):
- `.claude/spec-first/workflows/spec-polish/scripts/read-launch-json.sh` — launch.json reader
- `.claude/spec-first/workflows/spec-polish/scripts/detect-project-type.sh` — project-type classifier
- `.claude/spec-first/workflows/spec-polish/scripts/resolve-package-manager.sh` — lockfile-based package-manager resolver
- `.claude/spec-first/workflows/spec-polish/scripts/resolve-port.sh` — port resolution cascade
